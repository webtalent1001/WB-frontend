export default {
  ...
  customer: {
    ...
    'companyemail': 'Email to send invoice',
    'companyphone': 'Company Phone',
    'secondaryc_name': '2nd Contact Name',
    'secondaryc_phone': '2nd Company Phone',
    'secondaryc_email': 'Retailers email',
    'accounting_name': 'Accounting name',
    'accounting_phone': 'Accounting phone',
    'accounting_email': 'Accounting email',
    'fax': 'Fax',
    'deliveryc': 'Delivery Contact',
    'deliverye': 'Delivery email',
    'deliveryp': 'Delivery Phone',
    'deliveryday': 'Delivery Days',
    'salesrep': 'Sales Rep',
  ...
  order: {
    form: {
      customer: 'Customers',
      btnAddCustomer: 'Change Terms / Update Customer',
      date: 'Date',
      number: 'Sales Order',
      salesPerson: 'Sales Person',
      term: 'Terms',
      note: 'Add Order Note',
      fulfillNote: 'Notes for FulFillment Team',
      orderDiscount: 'Enter Order Discount',
      bTax: 'Don\'t Allow Tax',
      formPanel: 'Build Request',
      strain: 'Strain',
      pType: 'Product Type',
      qty: 'Qty',
      weight: 'Weight',
      row: {
        ...
        subTotal: 'Sub Total',
        cpu: 'CPU',
        discount: 'Per Row Discount',
        discountResult: 'Discount',
        discountType: 'Discount Type',
        eDiscount: 'Extra Discount',
        extended: 'Extended',
        tax: 'Tax',
        note: 'Note',
        total: 'Adjust Price',
      ...
      selectedInventoryBalance: {
        ...
        weight: 'Total Weight on Hand:'
      },
      inventoryStatus: 'Active Inventory as of ',
      messages: {
        qty: 'Please Enter Validate Qty'
      },
      btnSubmit: 'Build Sales Order'
    },
    archiveCommon: {
    }
  },
